...
for i in m1:
    ...
    for b in m1[y]:
        ...
        if b=="X":
                Hitbox(1, (x*tilesize,y*tilesize), (tilesize,tilesize),pygame.image.load("tierra.png"), "N", (tilesize,tilesize))

        if b=="-":
                Hitbox(1, (x*tilesize,y*tilesize), (tilesize,tilesize),pygame.image.load("pasto.png"), "N", (tilesize,tilesize))

        if b=="A":

                Hitbox(1, (x*tilesize,y*tilesize), (1, 1),pygame.image.load("pincho.png"), "A", (26, 39) )

        if b=="O":

                sierra((x*tilesize,y*tilesize), (20, 20),5, (x*tilesize+700, y*tilesize), 0, False,False )
        ...
        if b =="P":
            playerr = Player((x*32, y*32),spritescolision, enemigrup, (x*32,y*32))
        if b =="E":
            enemigo2(1, (x*32, y*32), (40,90), spritescolision, playergrup, enemigrup, False)
        if b =="i":
            enemigo1(1, (x*32, y*32), (40,90), spritescolision, playergrup, enemigrup, False)
        if b =="e":
            enemigo3(1, (x*tilesize, y*tilesize), (tilesize,tilesize), spritescolision, playergrup, enemigrup, False)
        if b == "p":
            pilar( (x*tilesize, y*tilesize-30), (tilesize/2,tilesize/2),"O", (80,90), "B","null", (255,200,150), (tilesize/2, tilesize/2))
